            ...
            <Reveal delay={0.1} className="lg:col-span-2">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-white/70 leading-relaxed">
                  ...
                  <p className="text-white/70 leading-relaxed">BIG DEE Security Solutions Limited Limited we aim to provide our employees with a respectful workplace. Being transparent and adapted to Good Corporate Governance — with strong commitment of BODs and team members, we are committed to perform better in the future. You can count on us.</p>
                  <p></p>
                </div>
