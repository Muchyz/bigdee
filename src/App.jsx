    ...
    <footer style={{ background: "#0f172a" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-4 pb-8">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <a href="https://www.instagram.com/bigdeesecuritysolutions?igsh=MWgxdnBpMTFlNzllcg==" target="_blank" rel="noopener noreferrer"
            className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:opacity-90"
          ...
          <a href="https://www.tiktok.com/@deegroup1" target="_blank" rel="noopener noreferrer"
            className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:opacity-90"
